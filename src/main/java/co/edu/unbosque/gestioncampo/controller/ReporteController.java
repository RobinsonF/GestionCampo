...
public class ReporteController {
    ...
    @GetMapping(path = "/cuadrillasP")
    public ResponseEntity<Resource> reporteCuadrillas2(@RequestParam Map<String, Object> params) {
        ReporteUsuarioDTO dto = reporteRepository.obtenerReporteCuadrilla2(params);
